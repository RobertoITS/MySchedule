package com.example.myschedule.weekcalendar.adapter
...
class EventAdapter(private val newEventList: ArrayList<NewEventData>, var app: Context): RecyclerView.Adapter<EventAdapter.EventViewHolder>(){
